...
from gp.nodes.batch_provider import BatchProvider


class WKSource(BatchProvider):
    """A `webknossos.Wk`_ data source.

    Provides arrays from wk datasets. If the attribute ``resolution`` is set
    ...
    Args:
        ...
        channels_first (``bool``, optional):
            ...
            Specifies the ordering of the dimensions of the wk-like data source.
